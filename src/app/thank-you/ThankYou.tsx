      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <div className="mt-12 text-sm font-medium">
            <p className="text-stone-900">Order number</p>
            <p className="mt-2 text-stone-500">{orderId}</p>
          </div>
        </div>
        ...
        <div className="mt-10 border-t border-stone-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-stone-600">
              We at JustInCase believe that a phone case doesn&apos;t only need
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-stone-200 py-10 text-sm">
            <div>
              <p className="font-medium text-stone-900">Payment status</p>
              <p className="mt-2 text-stone-700">Paid</p>
            </div>

            <div>
              <p className="font-medium text-stone-900">Shipping Method</p>
        ...
        <div className="space-y-6 border-t border-stone-200 pt-10 text-sm">
          <div className="flex justify-between">
            <p className="font-medium text-stone-900">Subtotal</p>
            <p className="text-stone-700">{formatPrice(amount)}</p>
          </div>
          <div className="flex justify-between">
            <p className="font-medium text-stone-900">Shipping</p>
            <p className="text-stone-700">{formatPrice(0)}</p>
          </div>
          <div className="flex justify-between">
