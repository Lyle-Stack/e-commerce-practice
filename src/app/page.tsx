          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto flex flex-col items-center text-center lg:items-start lg:text-left">
              <div className="absolute -top-20 left-0 hidden w-28 lg:block">
                ...
                <img src="/ecom-1.png" alt="hero-image" className="w-full" />
              </div>
              ...
              <p className="mt-8 max-w-prose text-balance text-center text-lg md:text-wrap lg:pr-10 lg:text-left">
                ...
                JustInCase allows you to protect your memories, not just your
                phone case.
              </p>
              ...
              <div className="mt-12 flex flex-col items-center gap-5 sm:flex-row sm:items-start">
                ...
                <div className="flex flex-col items-center justify-between sm:items-start">
                  ...
                  <p>
                    <span className="font-semibold">1,000+</span> happy
                    customers
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-6 lg:flex-row">
            <h2 className="order-1 mt-2 text-balance text-center text-5xl font-bold !leading-tight tracking-tight text-gray-900 md:text-6xl">
              ...
              <span className="relative px-2">
                customers{" "}
                <Icons.underline className="pointer-events-none absolute inset-x-0 -bottom-6 hidden text-orange-500 sm:block" />
              </span>{" "}
              say
            </h2>
            <img
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 text-balance text-center text-5xl font-bold !leading-tight tracking-tight text-gray-900 md:text-6xl">
                ...
                <span className="relative bg-orange-600 px-2 text-white">
                  your own case
                </span>{" "}
                now
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex grid-cols-2 flex-col items-center gap-40 md:grid">
              ...
              <div className="relative h-64 w-full max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 md:h-full md:justify-self-end lg:rounded-2xl">
                <img
                  src="/horse.jpg"
          ...
          <ul className="mx-auto mt-12 w-fit max-w-prose space-y-2 sm:text-lg">
            <li className="w-fit">
              <Check className="mr-1.5 inline h-5 w-5 text-orange-600" />
            ...
            <li className="w-fit">
              <Check className="mr-1.5 inline h-5 w-5 text-orange-600" />5 year
              print warranty
            </li>
